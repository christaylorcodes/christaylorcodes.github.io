...
1. **AI is really, really capable** (K = 8/10) - Superhuman in many domains, approaching human-level in general tasks
2. **We're moving incredibly fast** (I = 9.5/10) - Superhuman AI researchers predicted within 2 years
3. **With massive power concentration** (P = 8/10) - Single entities controlling significant portions of global compute
4. **Minimal safety investment** (S = 0.5/10) - Less than 0.05% of AI funding goes to safety
5. **Virtually no regulation** (R = 2/10) - Mostly voluntary frameworks and crossed fingers
6. **While maintaining our historical perfect record of handling powerful technology poorly** (C = 1.7)
...
- [AI-2027.com](https://ai-2027.com/) - Detailed scenario for superintelligent AI emergence by late 2027
- ["The Coming Wave" by Mustafa Suleyman](https://www.goodreads.com/book/show/90590134-the-coming-wave) - DeepMind co-founder on containing uncontainable technology

**AI Safety Research:**
- [Existential Risk from Artificial General Intelligence](https://forum.effectivealtruism.org/topics/artificial-general-intelligence) - Effective Altruism Forum
- [AI Alignment Forum](https://www.alignmentforum.org/) - Technical AI safety discussions
- [Center for AI Safety](https://www.safe.ai/) - Because someone should be worried professionally
- [Future of Life Institute](https://futureoflife.org/) - Researching existential risks

**Data & Reports:**
- [AI Index Report](https://aiindex.stanford.edu/) - Stanford HAI comprehensive data
- [State of AI Report](https://www.stateof.ai/) - Annual analysis of AI progress
...
*What's your AI doom coefficient? Think I'm too pessimistic? Too optimistic? Let me know at [ctaylor@christaylor.codes](mailto:ctaylor@christaylor.codes) or find me on [GitHub](https://github.com/christaylorcodes).*
