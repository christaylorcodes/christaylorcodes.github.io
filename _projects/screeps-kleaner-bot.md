---
layout: project
title: Screeps Kleaner Bot
icon: fa-gamepad
category: Gaming
short_description: Autonomous NPC bot for Screeps programming game that restores abandoned rooms to natural state while demonstrating advanced AI behavior patterns.
description: |
